...
register(
    ...
    entry_point='my_env.simple_combat:SimpleCombatEnv',
)
...
# Create environment
env = gym.make('SimpleCombatGame-v1')
...
# Save model
model.save("ppo_simple_combat_game_model")

model = PPO.load("ppo_simple_combat_game_model.zip", env=env)
